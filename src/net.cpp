...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Sheetgold " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"167.99.199.6", "www.sheetgold.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"sheetgoldtools.com", "testnet-seed.sheetgoldtools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Sheetgold is probably already running."), addrBind.ToString().c_str());
        else
